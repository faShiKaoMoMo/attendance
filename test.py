...
cursor.execute("""
    INSERT INTO travel (user_name, destination, reason, start_date, end_date, status, description, money, create_date, update_date)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
""", [(
'张三', '北京', '商务会议', '2024-03-15', '2024-03-18', 1, '参加年度技术峰会，与合作伙伴洽谈业务合作事宜', '5000.00', '2024-02-20 09:30:00', '2024-02-25T14:20:00'
), ('李四', '上海', '技术培训', '2024-03-22', '2024-03-25', 0, '参加AWS云计算架构师认证培训课程', '8000.00', '2024-02-25 10:15:00', '2024-02-25T10:15:00'),
('王五', '广州', '项目考察', '2024-04-01', '2024-04-05', 1, '考察新项目场地，与当地供应商会面洽谈合作细节', '6500.00', '2024-02-18 16:45:00', '2024-02-22T11:30:00'),
('赵六', '成都', '客户拜访', '2024-03-10', '2024-03-12', 2, '拜访重要客户，进行产品演示和需求调研', '3500.00', '2024-02-15 13:20:00', '2024-02-28T09:15:00'),
('钱七', '杭州', '行业展会', '2024-04-08', '2024-04-11', 0, '参加国际人工智能博览会，了解行业最新发展趋势', '7200.00', '2024-02-28 08:50:00', '2024-02-28T08:50:00'),
('孙八', '西安', '团队建设', '2024-03-28', '2024-03-31', 1, '组织部门团队建设活动，提升团队凝聚力', '4200.00', '2024-02-22 11:10:00', '2024-02-26T16:40:00'),
('周九', '深圳', '产品发布会', '2024-04-15', '2024-04-17', 0, '参加公司新产品发布会，协助现场技术支持', '5800.00', '2024-02-27 14:25:00', '2024-02-27T14:25:00'),
('吴十', '南京', '学术交流', '2024-03-05', '2024-03-08', 1, '参加全国计算机科学学术会议，发表研究成果', '4600.00', '2024-02-16 15:30:00', '2024-02-24T10:05:00')
])
