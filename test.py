...
test_travel_data = [
    ...
    ('王文凯', '九牧', '九牧RPA', '2025-11-11', '2025-11-12', 1, 8, '九牧RPA', '2025-10-27 09:30:00',
     '2025-10-27T14:20:00'),
    # 新增数据 (状态随机为 0, 1, 2)
    ('李明华', '海尔', '海尔智能家居', '2025-09-15', '2025-09-20', 1, 5, '海尔智能家居', '2025-09-15 10:00:00',
     '2025-09-15T15:30:00'),  # 审批中
    ('张小雨', '美的', '美的空调项目', '2025-08-01', '2025-08-10', 0, 10, '美的空调项目', '2025-08-01 08:30:00',
     '2025-08-01T12:00:00'),  # 待提交/草稿
    ('陈伟', '格力', '格力工业设计', '2025-10-05', '2025-10-09', 2, 4, '格力工业设计', '2025-10-05 14:00:00',
     '2025-10-05T18:50:00'),  # 完成
    ('刘芳', '小米', '小米AIoT平台', '2025-07-20', '2025-07-25', 1, 6, '小米AIoT平台', '2025-07-20 07:45:00',
     '2025-07-20T11:00:00'),  # 审批中
    ('赵刚', '华为', '华为云服务', '2025-09-28', '2025-10-04', 2, 7, '华为云服务', '2025-09-28 11:20:00',
     '2025-09-28T16:10:00'),  # 完成
    ('杨丽', '阿里巴巴', '阿里钉钉集成', '2025-06-10', '2025-06-18', 0, 9, '阿里钉钉集成', '2025-06-10 09:00:00',
     '2025-06-10T13:40:00'),  # 待提交/草稿
    ('周杰', '腾讯', '腾讯微信支付', '2025-10-15', '2025-10-22', 1, 8, '腾讯微信支付', '2025-10-15 13:00:00',
     '2025-10-15T17:25:00'),  # 审批中
    ('吴敏', '百度', '百度自动驾驶', '2025-08-25', '2025-09-03', 2, 10, '百度自动驾驶', '2025-08-25 06:30:00',
     '2025-08-25T10:55:00'),  # 完成
    ('郑凯', '京东', '京东物流优化', '2025-09-05', '2025-09-11', 0, 7, '京东物流优化', '2025-09-05 15:30:00',
     '2025-09-05T20:15:00'),  # 待提交/草稿
    (
    '钱蓉', '字节跳动', '字节跳动推荐系统', '2025-07-01', '2025-07-07', 1, 7, '字节跳动推荐系统', '2025-07-01 10:40:00',
    '2025-07-01T15:05:00')  # 审批中
]
...
test_leave_data = [
    ...
    ('张三', '2024-03-15', '2024-03-18', 1, '生病', '2024-02-20 09:30:00', '2024-02-25T14:20:00'),
    ('李四', '2024-03-22', '2024-03-25', 0, '生病', '2024-02-25 10:15:00', '2024-02-25T10:15:00'),
    ('王五', '2024-04-01', '2024-04-05', 1, '生病', '2024-02-18 16:45:00', '2024-02-22T11:30:00'),
    ('赵六', '2024-03-10', '2024-03-12', 2, '生病', '2024-02-15 13:20:00', '2024-02-28T09:15:00'),
    ('钱七', '2024-04-08', '2024-04-11', 0, '生病', '2024-02-28 08:50:00', '2024-02-28T08:50:00'),
    ('孙八', '2024-03-28', '2024-03-31', 1, '生病', '2024-02-22 11:10:00', '2024-02-26T16:40:00'),
    ('周九', '2024-04-15', '2024-04-17', 0, '生病', '2024-02-27 14:25:00', '2024-02-27T14:25:00'),
    ('吴十', '2024-03-05', '2024-03-08', 1, '生病', '2024-02-16 15:30:00', '2024-02-24T10:05:00')
]
